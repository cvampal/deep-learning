...
def train_and_evaluate(model, train_data, val_data, optimizer, loss_fn, metrics, params, model_dir, restore_file=None,arg={}):
    ...
    for epoch in range(params.num_epochs):
        ...
        val_metrics = evaluate(
            model, loss_fn, val_data_iterator, metrics, params, num_steps,hash_tb=arg)
...
if __name__ == '__main__':
    ...
    train_and_evaluate(model, train_data, val_data, optimizer, loss_fn, metrics, params, args.model_dir,
                       args.restore_file,arg=data_loader.tag_map)
